    ...
    <div class="container-fluid">
        <div class="card card-primary">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-3">
                        <form id="candidate_response_form">
                            ...
                            <div class="form-group">
                                <button id="save_candidate_reponse" type="button" class="btn btn-success pl-5 pr-5">Save</button>
                                <button id="update_candidate_reponse" type="button" class="btn btn-warning pl-5 pr-5 d-none">Update</button>
                            </div>
                        </form>
                    </div>
                    <div class="col-md-9">
                        <table class="table table-striped" id="candidate_resp_tbl">
                            <thead>
                                <th>#</th>
                                <th>Name</th>
                                <th>Designation</th>
...
@endsection
@section('pageScripts')
<script src="{{asset('js/candidate_response.js')}}"></script>
<script>
